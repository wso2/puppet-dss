...
1. Clone WSO2 DSS Puppet modules git repository and consider this path as `PUPPET_HOME`:

    ````
    git clone https://github.com/wso2/puppet-dss.git
    ````
...
5. Download and copy WSO2 DSS distribution to Puppet module under `files` folder:
